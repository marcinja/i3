...
you should place your code here."
  ...
  (setq neo-hidden-regexp-list '("^\\." "\\.pyc$" "~$" "^#.*#$" "\\.elc$" "\\.o$" "\\.a$"))
  (setq c-c++ :variables
